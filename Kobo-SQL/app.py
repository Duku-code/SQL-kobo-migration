...
""",
    ...
    required = {
        ...
        "SQL_SERVER_USER": bool(config_values["SQL_SERVER_USER"] or defaults.get("SQL_SERVER_USER")),
        "SQL_SERVER_PASSWORD": bool(config_values["SQL_SERVER_PASSWORD"] or defaults.get("SQL_SERVER_PASSWORD")),
    }
